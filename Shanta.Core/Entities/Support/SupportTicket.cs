...
namespace Shanta.Core.Entities.Support
{
    public class SupportTicket : BaseEntity
    {
        ...
        public AppUser? User { get; set; } // Navigation property to the user who created the ticket

        public List<TicketResponse>? Responses { get; set; } // Navigation property for ticket responses
    }
}
